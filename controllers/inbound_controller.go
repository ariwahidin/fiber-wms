...
func (c *InboundController) UpdateInboundByID(ctx *fiber.Ctx) error {
	...
	// return ctx.Status(fiber.StatusInternalServerError).JSON(fiber.Map{"error": "Testing"})
...
// private function untuk proses putaway per item
