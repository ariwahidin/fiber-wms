...
func SetupOutboundRoutes(app *fiber.App) {
	...
	api.Post("/upload-furuno-excel", outboundController.CreateOutboundFromFurunoExcel)
	...
	api.Post("/cancel", outboundController.HandleCancel)
	api.Post("/cancel/process", outboundController.ProccesHandleCancel)
